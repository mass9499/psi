     ...
     if(empty($this->session->userdata("user_id"))) { redirect("admin/login","refresh"); }
        $data['title'] ="Dashboard";
            ...
            if($res){
                foreach ($res as $key => $value) {
                  //  echo  $value->score;
                    ...
                    if($value->score >=0 && $value->score <= 20){
                        $val['first'] =   $val['first'] + 1;
                    }
                     if($value->score >=21 && $value->score <= 40){
                        $val['second'] =  $val['second']  + 1;
                    }
                     if($value->score >=41 && $value->score <= 60){
                        $val['third'] =  $val['third']  + 1;
                    }
                     if($value->score >=61 && $value->score <= 80){
                        $val['four'] =  $val['four']  + 1;
                    }
                     if($value->score >=81 && $value->score <= 100){
                        $val['five'] =  $val['five']  + 1;
                    }
                }
            }
           ...
           // pr($val);die;
            ...
            // $percentage_result = $this->Results_Model->get_percentage_result();
            // $data['percentage_result'] = count($percentage_result);
