                    ...
                    <div class="m-form__section m-form__section--first">
                        ...
                        <div class="form-group m-form__group row">
                         ...
                         <div class="form-group m-form__group row">
                            ...
                            <input type="hidden" name="old_audio" class="form-control" value="<?php echo $result->audio;?>" > 
                            </div>
                        </div>
  ...
  <?php if($answer){ $s=1;
    ...
    ?>
     <?php foreach ($answer as $key => $value) { ?>
       <input type="hidden" name="answer_id[<?php echo $key; ?>]" class="form-control" value="<?php echo $value->id;?>" required>
                          <div class="form-group m-form__group row">
                            <label class="col-lg-2 col-form-label">
                               Image
                            </label>
                            ...
                            <input type="file" name="answer[<?php echo $key; ?>]" class="form-control"> 
                             <input type="hidden" name="old_answer[<?php echo $key; ?>]" class="form-control" value="<?php echo $value->answer;?>" required>
                           </div>
                              <div class="col-lg-2">
                                Answer
                              </div>
                            <div class="col-lg-2">
                              <input type="radio" name="correct[<?php echo $key; ?>]"  value="1" class="correct-ans" <?php echo $value->correct_answer == 1 ? "checked" : "" ; ?> >
                            </div>

                             <div class="col-lg-2">
                                <a href="<?php echo base_url();?>admin/question/delete_answer/<?php echo $value->id;?>/<?php echo $result->id;?>" class="btn btn-danger" onclick="return confirm('Are you Sure?');"><i class="fa fa-trash"></i></a>
                            </div>
...
<script type="text/javascript">
     ...
     $("body").on("click",".correct-ans",function(){
      //alert();
          var  a = $(this);
          $(".correct-ans").prop('checked', false);

          a.prop("checked", true);
          //$(".correct-ans").removeAttr('checked');
