        ...
        <div class="kt-portlet kt-portlet--mobile">
          ...
          <form method="post" action="" enctype="multipart/form-data" > 
                    ...
                    <div class="col-lg-6">
                      <select class="form-control" name="country_id" required="">
                        ...
                        <?php foreach ($countries as $key => $country): ?>
                            <option value="<?php echo $country->id ?>"   <?php echo $country->id == $result->country_id ? "selected": "";  ?> > <?php echo $country->countries_name; ?>  </option>
                        <?php endforeach ?>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                       <input type="text" name="city_name" class="form-control" value="<?php echo $result->city_name; ?>" required>
                    </div>
                </div>
