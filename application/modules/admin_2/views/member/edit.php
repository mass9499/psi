                        ...
                        <div class="m-portlet__body">
                            <div class="m-form__section m-form__section--first">
                                  ...
                                  <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6">
                                           <input type="number" class="form-control" name="contact_no" value="<?php echo $result->contact_no ; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6">
                                        <select class="form-control" name="operator_id" required>
                                            ...
                                            <option value="<?php echo $row->id ?> " <?php echo $result->operator_id == $row->id ? 'selected' : ' ' ; ?> > <?php echo $row->group_name ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
