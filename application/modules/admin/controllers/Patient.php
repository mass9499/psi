      ...
      function create(){
         ...
         if($this->input->server("REQUEST_METHOD")=="POST"){        
          ...
          if ($this->form_validation->run() == TRUE){
                ...
                $data['left_normal_hear']          =   $datas['left_normal_hear'];
                $data['left_hearing_device']       =   $datas['left_hearing_device'];
                $data['left_implant_date']         =   $datas['left_implant_date'];
                $data['right_normal_hear']         =   $datas['right_normal_hear'];
                $data['right_hearing_device']      =   $datas['right_hearing_device'];
                $data['right_implant_date']        =   $datas['right_implant_date'];
    ...
    public function edit($id) {
       if($this->input->server("REQUEST_METHOD")=="POST"){
            ...
            $data['gender']         =   @$datas['gender'];
             ...
             $data['left_normal_hear']          =   $datas['left_normal_hear'];
                $data['left_hearing_device']       =   $datas['left_hearing_device'] ?  $datas['left_hearing_device'] : "";
                $data['left_implant_date']         =   $datas['left_implant_date'];
                $data['right_normal_hear']         =   $datas['right_normal_hear'];
                $data['right_hearing_device']      =   $datas['right_hearing_device'] ? $datas['right_hearing_device'] : "";
                $data['right_implant_date']        =   $datas['right_implant_date'];
                

            $res = $this->Patient_Model->update('patient','id',$id,$data);
