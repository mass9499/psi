...
<html lang="en">
	...
	<head>
		<base href="../../../">
		<meta charset="utf-8" />
		<title>Login |  <?php echo $setting->company_name;?></title>
	...
	<!-- begin::Body -->
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading"  data-url="<?php echo base_url();?>" >
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							<div class="kt-login__logo">
								<a href="#">
							 <img src="<?php echo base_url();?><?php echo $setting->image_name;?>" alt="<?php echo $setting->company_name ;?>"  width="200" />
								</a>
							</div>
		...
		<script src="<?php echo base_url();?>assets/admin/js/pages/custom/login/login-general.js" type="text/javascript"></script>
