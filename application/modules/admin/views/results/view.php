             ...
             <table class="table table-bordered">
                <thead>
                    ...
                    <tr> 
                     ...
                     <tr>
                        <th>Ear Side :</th> 
                        <td>  <?php if($test_detail->ear_side == 1) echo "LEFT EAR" ; 
                                     else if($test_detail->ear_side == 2) echo  "RIGHT  EAR";
                                     else if($test_detail->ear_side ==3) echo "BOTH"?></td>
                    </tr>
                                ...
                                ?>
                                 <div>
                                   <br>Question <?php echo$s++ ;?> : <?php echo $question->name;?>
                                    <span>
                                           <?php if($question->answer_status==1) {  ?>
                                            <span class="badge badge-success"> <i class="flaticon2-checkmark"></i></span>
                                            
                                             <?php }  elseif($question->answer_status== -1) {  ?>
