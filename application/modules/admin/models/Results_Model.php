    ...
    if($fliters){
       ...
       if($fliters['patient']){
        ...
        if($fliters['result_range']){
         ...
         if($fliters['left_hearing_device']){

            $this->db->where('patient.left_hearing_device',$fliters['left_hearing_device']);
       }
       
    
          if($fliters['right_hearing_device']){

            $this->db->where('patient.right_hearing_device',$fliters['right_hearing_device']);
       }
       
       //  if($fliters['hearing_device']){

       //      $this->db->where('',$fliters['hearing_device']);
       // }   
