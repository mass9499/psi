                    ...
                    <div class="m-form__section m-form__section--first">
                        ...
                        <div class="row ">
                          <div class="col-lg-6">
                            ...
                            <div class="form-group m-form__group row">
                                <div class="col-lg-1">
                                    <input type="checkbox" value="1" name="l_cochlear_implant_ear" class="checkbox-right">
                                </div>
                                 <div class="col-lg-11">
                            ...
                            <div class="form-group m-form__group row">
                             ...
                             <div class="form-group m-form__group row">
                                <div class="col-lg-1">
                                 ...
                                 <div class="col-lg-5">
                                 <label class="col-form-label">Brainstem implant</label>   
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <div class="col-lg-10">
                                  <label class="col-form-label">When did you receive your hearing  implant?</label>   
                                </div>
                                <div class="col-lg-2">
                          ...
                          <div class="col-lg-6">
                            ...
                            <div class="form-group m-form__group row">
                                <div class="col-lg-1">
                                    <input type="checkbox" value="1" name="r_cochlear_implant_ear" class="checkbox-right">
                                </div>
                                 <div class="col-lg-11">
                                 <label class="col-form-label">Cochlear implant + integrated hearing Aid (EAS) </label>   
                                </div>
