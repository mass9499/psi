			...
			<div class="content-box">
            	<div class="form_components">
            		...
            		<div class="form_detail">
									...
									<!--begin::Form-->
									<form class="m-form m-form--label-align-right" action="" method="post" enctype="multipart/form-data" >
										<div class="m-portlet__body">
											<div class="m-form__section m-form__section--first">
												...
												<div class="form-group m-form__group row">
													...
													<div class="col-lg-6">
														<input type="file" name="attch" class="form-control">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-6">
														<button type="submit" class="btn btn-primary">
															<?php echo $this->lang->line('permission_submit'); ?>
														</button>
